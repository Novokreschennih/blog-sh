...
1.  Владелец бизнеса легко добавляет свою компанию в личный кабинет SetHubble.
    ...
    <img src="/content/news/october-01-2025/offline-dashboard.png" alt="Панель управления для наземного бизнеса в SetHubble" loading="lazy">
...
2.  Система **автоматически создает стильный сайт-визитку** с QR-кодом для прямого подключения клиентов.
    ...
    <img src="/content/news/october-01-2025/offline-landing-page.png" alt="Пример сайта-визитки для компании на SetHubble" loading="lazy">
